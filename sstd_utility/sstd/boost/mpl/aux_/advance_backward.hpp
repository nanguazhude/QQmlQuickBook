...
#   include <sstd/boost/mpl/limits/unrolling.hpp>
...
#   define BOOST_PP_ITERATION_PARAMS_1 \
    (3,(0, BOOST_MPL_LIMIT_UNROLLING, <sstd/boost/mpl/aux_/advance_backward.hpp>))
...
#   define BOOST_PP_ITERATION_PARAMS_2 \
    (3,(1, BOOST_PP_FRAME_ITERATION(1), <sstd/boost/mpl/aux_/advance_backward.hpp>))
#   include BOOST_PP_ITERATE()
#endif
