...
#   include <sstd/boost/mpl/bind_fwd.hpp>
...
#   include <sstd/boost/mpl/aux_/arity_spec.hpp>
#   include <sstd/boost/mpl/aux_/type_wrapper.hpp>
...
#include <sstd/boost/mpl/aux_/config/bind.hpp>
...
#   endif
#   include <sstd/boost/mpl/aux_/include_preprocessed.hpp>

#else

#   include <sstd/boost/mpl/aux_/preprocessor/params.hpp>
#   include <sstd/boost/mpl/aux_/preprocessor/default_params.hpp>
#   include <sstd/boost/mpl/aux_/preprocessor/def_params_tail.hpp>
#   include <sstd/boost/mpl/aux_/preprocessor/partial_spec_params.hpp>
#   include <sstd/boost/mpl/aux_/preprocessor/ext_params.hpp>
#   include <sstd/boost/mpl/aux_/preprocessor/repeat.hpp>
#   include <sstd/boost/mpl/aux_/preprocessor/enum.hpp>
#   include <sstd/boost/mpl/aux_/preprocessor/add.hpp>
#   include <sstd/boost/mpl/aux_/config/dmc_ambiguous_ctps.hpp>
#   include <sstd/boost/mpl/aux_/config/ctps.hpp>
...
#define BOOST_PP_ITERATION_PARAMS_1 \
    (3,(0, BOOST_MPL_LIMIT_METAFUNCTION_ARITY, <sstd/boost/mpl/bind.hpp>))
...
#   define BOOST_PP_ITERATION_PARAMS_1 (3,(3, 3, <sstd/boost/mpl/bind.hpp>))
#   include BOOST_PP_ITERATE()
...
#include <sstd/boost/mpl/aux_/count_args.hpp>
}
...
#       define BOOST_PP_ITERATION_PARAMS_2 (3,(1, i_, <sstd/boost/mpl/bind.hpp>))
#       include BOOST_PP_ITERATE()
