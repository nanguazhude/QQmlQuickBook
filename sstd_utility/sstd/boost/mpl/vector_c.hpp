...
#   include <sstd/boost/mpl/limits/vector.hpp>
...
#   include BOOST_PP_STRINGIZE(sstd/boost/mpl/vector/AUX778076_VECTOR_C_HEADER)
...
#   include <sstd/boost/mpl/aux_/sequence_wrapper.hpp>
