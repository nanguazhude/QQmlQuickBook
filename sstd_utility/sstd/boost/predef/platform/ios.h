...
#include <sstd/boost/predef/os/ios.h> // BOOST_OS_IOS
#include <sstd/boost/predef/version_number.h> // BOOST_VERSION_NUMBER_NOT_AVAILABLE
...
#    include <sstd/boost/predef/detail/platform_detected.h>
#endif
