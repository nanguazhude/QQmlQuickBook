...
#include <sstd/boost/mpl/vector/vector0.hpp>
...
#   include <sstd/boost/mpl/vector/vector10.hpp>
...
#   include <sstd/boost/function_types/detail/classifier.hpp>
#endif
...
#include <sstd/boost/function_types/config/config.hpp>

#   if   BOOST_FT_MAX_ARITY < 10
#     include <sstd/boost/mpl/vector/vector10.hpp>
#   elif BOOST_FT_MAX_ARITY < 20
#     include <sstd/boost/mpl/vector/vector20.hpp>
#   elif BOOST_FT_MAX_ARITY < 30
#     include <sstd/boost/mpl/vector/vector30.hpp>
#   elif BOOST_FT_MAX_ARITY < 40
#     include <sstd/boost/mpl/vector/vector40.hpp>
#   elif BOOST_FT_MAX_ARITY < 50
#     include <sstd/boost/mpl/vector/vector50.hpp>
#   endif

#include <sstd/boost/function_types/detail/class_transform.hpp>
...
#include <sstd/boost/function_types/detail/components_as_mpl_sequence.hpp>
