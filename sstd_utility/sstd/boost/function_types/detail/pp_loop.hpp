...
#   include <sstd/boost/preprocessor/punctuation/paren.hpp>
#endif

#include <sstd/boost/function_types/detail/encoding/def.hpp>
#include <sstd/boost/function_types/detail/encoding/aliases_def.hpp>

#if defined(BOOST_FT_PREPROCESSING_MODE)
#   define BOOST_FT_loop <sstd/boost/function_types/detail/pp_cc_loop/master.hpp>
#else
#   define BOOST_FT_loop \
        <sstd/boost/function_types/detail/pp_cc_loop/preprocessed.hpp>
#endif

#if defined(BOOST_FT_al_path)

#   define BOOST_FT_cc_file \
        <sstd/boost/function_types/detail/pp_variate_loop/preprocessed.hpp>
#   define BOOST_FT_variate_file \
        <sstd/boost/function_types/detail/pp_arity_loop.hpp>
