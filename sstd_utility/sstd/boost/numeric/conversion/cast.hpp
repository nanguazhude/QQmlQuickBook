...
#  include<sstd/boost/numeric/conversion/detail/old_numeric_cast.hpp>

#else

#include <sstd/boost/type.hpp>
#include <sstd/boost/numeric/conversion/converter.hpp>
#include <sstd/boost/numeric/conversion/numeric_cast_traits.hpp>
