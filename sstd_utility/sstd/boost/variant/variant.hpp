...
#include <sstd/boost/variant/detail/config.hpp>
#include <sstd/boost/mpl/aux_/value_wknd.hpp>

#include <sstd/boost/variant/variant_fwd.hpp>
#include <sstd/boost/variant/detail/backup_holder.hpp>
#include <sstd/boost/variant/detail/enable_recursive_fwd.hpp>
#include <sstd/boost/variant/detail/forced_return.hpp>
#include <sstd/boost/variant/detail/initializer.hpp>
#include <sstd/boost/variant/detail/make_variant_list.hpp>
#include <sstd/boost/variant/detail/over_sequence.hpp>
#include <sstd/boost/variant/detail/visitation_impl.hpp>
#include <sstd/boost/variant/detail/hash_variant.hpp>

#include <sstd/boost/variant/detail/generic_result_type.hpp>
#include <sstd/boost/variant/detail/move.hpp>

#include <sstd/boost/detail/no_exceptions_support.hpp>
#include <sstd/boost/detail/reference_content.hpp>
#include <sstd/boost/aligned_storage.hpp>
#include <sstd/boost/blank.hpp>
#include <sstd/boost/integer/common_factor_ct.hpp>
...
#include <sstd/boost/utility/declval.hpp>
#include <sstd/boost/variant/recursive_wrapper_fwd.hpp>
#include <sstd/boost/variant/static_visitor.hpp>
...
#include <sstd/boost/variant/detail/variant_io.hpp>
