...
#include <sstd/boost/multi_index/detail/copy_map.hpp>
#include <sstd/boost/multi_index/detail/do_not_copy_elements_tag.hpp>
#include <sstd/boost/multi_index/detail/node_type.hpp>
...
#include <sstd/boost/multi_index/detail/index_loader.hpp>
#include <sstd/boost/multi_index/detail/index_saver.hpp>
#endif
...
protected:
  ...
  final_node_type* insert_(const value_type& v,final_node_type*& x,rvalue_tag)
  {
    ...
    BOOST_TRY{
       ...
       * <sstd/boost/detail/allocator_utilities.hpp> is too old and venerable to
