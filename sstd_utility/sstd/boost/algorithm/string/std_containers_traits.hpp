...
#include <sstd/boost/algorithm/string/std/string_traits.hpp>
#include <sstd/boost/algorithm/string/std/list_traits.hpp>

#ifdef BOOST_HAS_SLIST
#   include <sstd/boost/algorithm/string/std/slist_traits.hpp>
#endif
