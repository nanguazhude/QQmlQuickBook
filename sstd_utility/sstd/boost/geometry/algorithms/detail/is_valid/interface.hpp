...
#include <sstd/boost/geometry/policies/is_valid/default_policy.hpp>
#include <sstd/boost/geometry/policies/is_valid/failing_reason_policy.hpp>
#include <sstd/boost/geometry/policies/is_valid/failure_type_policy.hpp>
