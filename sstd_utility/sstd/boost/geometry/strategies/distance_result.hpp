...
#include <sstd/boost/geometry/util/compress_variant.hpp>
#include <sstd/boost/geometry/util/transform_variant.hpp>
#include <sstd/boost/geometry/util/combine_if.hpp>
