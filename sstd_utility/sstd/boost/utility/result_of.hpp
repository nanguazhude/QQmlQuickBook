...
#define BOOST_PP_ITERATION_PARAMS_1 (3,(0,BOOST_RESULT_OF_NUM_ARGS,<sstd/boost/utility/detail/result_of_iterate.hpp>))
#include BOOST_PP_ITERATE()

#if 0
// inform dependency trackers, as they can't see through macro includes
#include <sstd/boost/utility/detail/result_of_iterate.hpp>
#endif
