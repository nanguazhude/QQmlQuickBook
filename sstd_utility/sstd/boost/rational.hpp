...
#include <sstd/boost/config.hpp>      // for BOOST_NO_STDC_NAMESPACE, BOOST_MSVC, etc
...
#include <sstd/boost/operators.hpp>   // for boost::addable etc
#include <cstdlib>               // for std::abs
#include <sstd/boost/call_traits.hpp> // for boost::call_traits
#include <sstd/boost/detail/workaround.hpp> // for BOOST_WORKAROUND
#include <sstd/boost/assert.hpp>      // for BOOST_ASSERT
#include <sstd/boost/integer/common_factor_rt.hpp> // for boost::integer::gcd, lcm
#include <limits>                // for std::numeric_limits
#include <sstd/boost/static_assert.hpp>  // for BOOST_STATIC_ASSERT
