...
//   01 Apr 01  Modified to use new <sstd/boost/limits.hpp> header. (John Maddock)
...
#include <sstd/boost/integer_fwd.hpp>  // self include

#include <sstd/boost/integer_traits.hpp>  // for boost::::boost::integer_traits
#include <sstd/boost/limits.hpp>          // for ::std::numeric_limits
#include <sstd/boost/cstdint.hpp>         // for boost::int64_t and BOOST_NO_INTEGRAL_INT64_T
