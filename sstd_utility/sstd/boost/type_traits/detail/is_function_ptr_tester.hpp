...
#define PP2 <sstd/boost/preprocessor/enum_params.hpp>
#define PP3 <sstd/boost/preprocessor/comma_if.hpp>
#include PP1
#include PP2
#include PP3
#undef PP1
...
#define BOOST_PP_ITERATION_PARAMS_1 \
    (3, (0, 25, "sstd/boost/type_traits/detail/is_function_ptr_tester.hpp"))
