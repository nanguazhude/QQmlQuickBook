...
//
#define PPI <sstd/boost/preprocessor/iterate.hpp>
#include PPI
#undef PPI
#define PPI <sstd/boost/preprocessor/enum_params.hpp>
#include PPI
#undef PPI
#define PPI <sstd/boost/preprocessor/comma_if.hpp>
#include PPI
#undef PPI
#endif
...
#define BOOST_PP_ITERATION_PARAMS_1 \
    (3, (0, 25, "sstd/boost/type_traits/detail/is_mem_fun_pointer_tester.hpp"))
