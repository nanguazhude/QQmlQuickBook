...
#include <sstd/boost/multiprecision/detail/bitscan.hpp> // lsb etc
#include <sstd/boost/integer/common_factor_rt.hpp> // gcd/lcm
#include <sstd/boost/functional/hash_fwd.hpp>
